...
// export.index = function(req, res){objects of functions, final_callback}
exports.index = function (req, res) {
    // async.parallel( {functions}, callbackFunction )
    async.parallel(
        {
...
exports.book_update_post = [
    ...
    (req, res, next) => {
        ...
        var book = new Book({
            ...
            _id: req.params.id, // So that new id won't be assigned
        });
